                ...
                <form enctype="multipart/form-data" action="#" method="">
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-1/3 mb-4 mr-4">
                            <label for="unitName" class="block mb-2 text-sm font-medium text-gray-900">Unit
                                Name</label>
                            <input value="" type="text" name="unitName" id="unitName"
                        ...
                        <div class="w-1/3 mb-4 mr-4">
                            <label for="shortName" class="block mb-2 text-sm font-medium text-gray-900">Short
                                Name</label>
                            <input value="" type="text" name="shortName" id="shortName"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
