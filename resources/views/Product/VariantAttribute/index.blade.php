    ...
    <section class="py-4">
        ...
        <div class="p-4 sm:ml-64 mt-1">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
                ...
                <form enctype="multipart/form-data" action="{{ route('VariantAttribiute.store') }}" method="POST">
                    @csrf
                    @method('post')
                    <div class="flex flex-wrap">
                        <div class="w-1/3 mb-4 mr-4">
                            <label for="title" class="block mb-2 text-sm font-medium text-gray-900">Attribute
                                Name</label>
                        ...
                        <tbody>
                            @foreach ($attributes as $attribute)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">
                                        Edit |
                                        <form action="{{ route('VariantAttribiute.destroy', $attribute->id) }}"
