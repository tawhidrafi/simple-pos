...
<div class="flex justify-between mb-4">
    <h2 class="text-2xl font-extrabold">Expense Categories</h2>
...
<div class="bg-white shadow-md rounded-lg">
    <div class="p-6">
        <div>
            <h3 class="text-lg font-semibold text-gray-700 mb-4">Expense categories List</h3>
            <div class="border rounded-lg overflow-hidden">
                <table class="w-full text-sm text-gray-600">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            <td class="py-2 px-4 text-left">{{ $expenseCategory->name }}</td>
                            <td class="py-2 px-4 text-left">
                                <a href="{{ route('expense-categories.show', $expenseCategory->id) }}">
                                    <button
                                        type="button"
                                        class="text-blue-700 hover:text-white border-2 border-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-lg text-sm px-2 py-1 text-center mr-4 open-edit-modal">
                                        View
                                    </button>
                                </a>
                                <button
                                    ...
                                    data-modal-target="crud-modal"
                                    data-modal-toggle="crud-modal"
                                    data-expenseCategory-id="{{ $expenseCategory->id }}"
                                    data-expenseCategory-name="{{ $expenseCategory->name }}"
...
<div
    ...
    <div
        ...
        <div
            ...
            <!-- Modal body -->
            <form
                id="expenseCategory-form"
                class="p-4 md:p-5"
                method="POST"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" id="expenseCategory-id" name="id">
                ...
                <button
                    type="submit"
                    id="expenseCategory-submit-button"
...
@push('scripts')
@vite(['resources/js/expense-category.js'])
