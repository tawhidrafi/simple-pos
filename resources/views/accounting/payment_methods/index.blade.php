...
<div class="flex justify-between mb-4">
    <h2 class="text-2xl font-extrabold">Payment Methods</h2>
...
<div class="bg-white shadow-md rounded-lg">
    <div class="p-6">
        <div>
            <h3 class="text-lg font-semibold text-gray-700 mb-4">Payment methods List</h3>
            <div class="border rounded-lg overflow-hidden">
                <table class="w-full text-sm text-gray-600">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            <td class="py-2 px-4 text-left">{{ $paymentMethod->name }}</td>
                            <td class="py-2 px-4 text-left">
                                <button
                                    type="button"
                                    data-modal-target="crud-modal"
                                    data-modal-toggle="crud-modal"
                                    data-paymentMethod-id="{{ $paymentMethod->id }}"
                                    data-paymentMethod-name="{{ $paymentMethod->name }}"
    ...
    <div
        ...
        <div
            ...
            <form
                ...
                @csrf
                <input type="hidden" id="paymentMethod-id" name="id">
                ...
                <button
                    type="submit"
                    id="paymentMethod-submit-button"
...
@push('scripts')
@vite(['resources/js/payment-method.js'])
